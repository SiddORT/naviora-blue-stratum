"""PASE Simulator adapter — stub implementation."""
from typing import Any

from app.adapters.base_adapter import BaseSimulatorAdapter


class PASEAdapter(BaseSimulatorAdapter):
    """Adapter for PASE Maritime Simulators."""

    async def test_connection(self) -> dict[str, Any]:
        self._log("info", "test_connection called", base_url=self.base_url)
        return {
            "success": False,
            "message": "PASE adapter integration not yet configured.",
            "latency_ms": None,
        }
