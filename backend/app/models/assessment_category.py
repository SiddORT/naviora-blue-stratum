"""Assessment Category model — groups assessments by domain."""
...
class AssessmentCategory(TimestampMixin):
    ...
    templates: Mapped[list["AssessmentTemplate"]] = relationship(
        "AssessmentTemplate", back_populates="category", lazy="noload"
    )

    def __repr__(self) -> str:
        return f"<AssessmentCategory id={self.id} code={self.category_code!r}>"
